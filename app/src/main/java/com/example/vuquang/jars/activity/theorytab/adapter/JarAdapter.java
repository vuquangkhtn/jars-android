...
public class JarAdapter extends RecyclerView.Adapter<JarAdapter.JarHolder> {
    ...
    public void onBindViewHolder(JarHolder holder, int position) {
        ...
        holder.imvIcon.setImageResource(jar.resIcon);
        String name = jar.name+" ("+String.valueOf(Math.round(jar.ratio *100))+"%)";
        holder.tvName.setText(name);
        holder.tvAmount.setText(String.valueOf(jar.amount));
    }
